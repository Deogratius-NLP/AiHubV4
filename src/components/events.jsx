import classImg from '../assets/event3.jpg';
import coorpImg from '../assets/event2.jpg';
import facilityImg from '../assets/event1.jpg';
        ...
        <div className="events-grid">
          <div className="event-card" data-aos="fade-up">
            <div className="event-image">
              <img src={classImg} alt="Deep Learning Fundamentals" loading="lazy" />
            </div>
          ...
          <div className="event-card" data-aos="fade-up" data-aos-delay={100}>
            <div className="event-image">
              <img src={coorpImg} alt="AI Innovation Summit" loading="lazy" />
            </div>
            <div className="event-date">
          ...
          <div className="event-card" data-aos="fade-up" data-aos-delay={200}>
            <div className="event-image">
              <img src={facilityImg} alt="AI Hackathon 2026" loading="lazy" />
            </div>
            <div className="event-date">
